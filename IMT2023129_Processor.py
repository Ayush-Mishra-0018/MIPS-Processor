...
#file1 = open("IMT2023129_fibonacci_instructionmemory.txt", "r")
#file1 = open("IMT2023129_power_instructionmemory.txt", "r")
file1 = open("IMT2023129_factorial_instructionmemory.txt", "r")
...
#datafile=open("IMT2023129_fibonacci_datamemory.txt","r")
#datafile=open("IMT2023129_power_datamemory.txt","r")
datafile=open("IMT2023129_factorial_datamemory.txt","r")
